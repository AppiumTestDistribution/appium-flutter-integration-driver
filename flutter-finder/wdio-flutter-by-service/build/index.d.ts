...
declare global {
    namespace WebdriverIO {
        interface Browser {
            ...
            flutterByValueKey$(value: string): ChainablePromiseElement;
            flutterByValueKey$$(value: string): ChainablePromiseElement[];
            flutterBySemanticsLabel(label: string): Promise<Flutter.Locator>;
            flutterBySemanticsLabel$(label: string): ChainablePromiseElement;
            flutterBySemanticsLabel$$(label: string): ChainablePromiseElement[];
            flutterByText(text: string): Promise<Flutter.Locator>;
            flutterByText$(text: string): ChainablePromiseElement;
            flutterByType(text: string): Promise<Flutter.Locator>;
            flutterByType$(text: string): ChainablePromiseElement;
            flutterByType$$(text: string): ChainablePromiseElement[];
            flutterByText$$(text: string): ChainablePromiseElement[];
